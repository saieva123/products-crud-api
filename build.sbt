...
bashScriptExtraDefines ++= Seq("""addApp "-log.level=${LOG_LEVEL:-INFO}"""",
                               """addApp "-swagger.docs.endpoint=${SWAGGER_DOC_PATH:-/finatrasample/docs}"""",
...
defaultLinuxInstallLocation in Docker := "/opt/services"
packageName                 in Docker := "vr/services"
...
maintainer         in Docker := "Elsa <saieva.bi01g@g2.nctu.edu.tw>"
...
dockerEnvVars := Map("LANG" -> "C.UTF-8", "LC_ALL" -> "C.UTF-8", "SERVICE_NAME" -> "services", "SERVICE_TAGS" -> "vr,service")
